          ...
          <table class="table-custom" width="75%">
            <tr>
              ...
              <td>
                <label>
                  <span>统计区间起</span>
                  <el-date-picker type="month" placeholder="选择月份" :editable="false" v-model="searchForm.startTime"></el-date-picker>
                </label>
              </td>
              <td>
                <label>
                  <span>统计区间止</span>
                  <el-date-picker type="month" placeholder="选择月份" :editable="false" v-model="searchForm.endTime"></el-date-picker>
                </label>
              </td>
            </tr>
          </table>
